 ...
 *****************************************************************************/
 ...
 module.exports = {
    user          : process.env.NODE_ORACLEDB_USER || "onemore_upd",
    ...
    // needed.
    password      : process.env.NODE_ORACLEDB_PASSWORD || "Welcome_1",
  
    // For information on connection strings see:
    // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
    connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=onemore.iris-eg.com)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SID=orcl)))",
